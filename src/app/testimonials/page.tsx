...
export const metadata: Metadata = {
  title: "Testimonials :: Art of Living CI",
  description:
    "Read testimonials from dancers and community members sharing their experiences with Michael Bernal, Art of Living, and related contact improvisation practice.",
};
